...
from pulumi.output import Input, Output, UNKNOWN, input_type, input_property
...
@input_type
class FooArgs:
    first_arg: Input[str] = input_property("firstArg")
    second_arg: Optional[Input[float]] = input_property("secondArg")
...
@input_type
class BarArgs:
    tag_args: Input[dict] = input_property("tagArgs")
